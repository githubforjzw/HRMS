...
public class Config_file_third_kind implements Serializable{
	...
	public String toString() {
		return "Config_file_third_kind [ftk_id=" + ftk_id + ", first_kind_id=" + config_file_second_kind.getConfig_file_first_kind().getFirst_kind_id() + ", first_kind_name="
				+ config_file_second_kind.getConfig_file_first_kind().getFirst_kind_name() + ", second_kind_id=" + config_file_second_kind.getSecond_kind_id() + ", second_kind_name=" + config_file_second_kind.getSecond_kind_name()
