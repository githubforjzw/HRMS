...
public class Human_file_dig implements Serializable{
	...
	private DecimalFormat demand_salaray_sum ;
	private DecimalFormat paid_salary_sum ;
	...
	public String toString() {
		return "Human_file_dig [hfd_id=" + hfd_id + ", human_id=" + human_id + ", first_kind_id=" + first_kind_id
	...
	public DecimalFormat getDemand_salaray_sum() {
		return demand_salaray_sum;
	}

	public void setDemand_salaray_sum(DecimalFormat demand_salaray_sum) {
		this.demand_salaray_sum = demand_salaray_sum;
	}

	public DecimalFormat getPaid_salary_sum() {
		return paid_salary_sum;
	}

	public void setPaid_salary_sum(DecimalFormat paid_salary_sum) {
