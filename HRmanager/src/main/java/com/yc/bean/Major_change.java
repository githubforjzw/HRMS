...
public class Major_change implements Serializable{
	...
	private DecimalFormat new_salary_sum ;
	...
	public String toString() {
		return "Major_change [mch_id=" + mch_id + ", first_kind_id=" + first_kind_id + ", first_kind_name="
				...
				+ major_name + ", new_first_kind_id=" + new_first_kind_id + ", new_first_kind_name="
				+ new_first_kind_name + ", new_second_kind_id=" + new_second_kind_id + ", new_second_kind_name="
				+ new_second_kind_name + ", new_third_kind_id=" + new_third_kind_id + ", new_third_kind_name="
				+ new_third_kind_name + ", new_major_kind_id=" + new_major_kind_id + ", new_major_kind_name="
				+ new_major_kind_name + ", new_major_id=" + new_major_id + ", new_major_name=" + new_major_name
				+ ", human_id=" + human_id + ", human_name=" + human_name + ", salary_standard_id=" + salary_standard_id
				+ ", salary_standard_name=" + salary_standard_name + ", salary_sum=" + salary_sum
				+ ", new_salary_standard_id=" + new_salary_standard_id + ", new_salary_standard_name="
				+ new_salary_standard_name + ", new_salary_sum=" + new_salary_sum + ", change_reason=" + change_reason
				+ ", check_reason=" + check_reason + ", check_status=" + check_status + ", register=" + register
	...
	public DecimalFormat getNew_salary_sum() {
		return new_salary_sum;
	}

	public void setNew_salary_sum(DecimalFormat new_salary_sum) {
