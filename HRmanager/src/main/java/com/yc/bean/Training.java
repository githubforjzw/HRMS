...
public class Training implements Serializable{
	...
	public String toString() {
		return "Training [tra_id=" + tra_id + ", config_major=" + config_major + ", human_file_dig=" + human_file_dig
				+ ", training_item=" + training_item + ", training_time=" + training_time + ", training_hour="
				+ training_hour + ", training_degree=" + training_degree + ", register=" + register + ", checker="
				+ checker + ", regist_time=" + regist_time + ", check_time=" + check_time + ", checkstatus="
